...
function ShaderInput(props: ShaderInputProps) {
  ...
  useEffect(() => {
    ...
    try{
      ...
      const compiledSource = Skia.RuntimeEffect.Make(preamble + debouncedShader);
  ...
  return <TextInput {...props} autoCorrect={false} spellCheck={false} placeholderTextColor={'#888'} multiline style={[styles.container, props.style, !isValid && styles.invalid]}
